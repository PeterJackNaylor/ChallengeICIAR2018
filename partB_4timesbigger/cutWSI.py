...
s_0_x, s_0_y = UOS.get_size(scan, 448 * 2, 448 * 2, 0, last_dim_n)

channels = ((mask_tissue, 0), (Red_area, 1), (Green_area, 2), (Blue_area, 3))
...
for c, k in channels:
    ...
    while ((c_cop > 0).sum() > 0 and i < number_of_imgs):
        ...
        list_channel.append([y_0, x_0, 448 * 2, 448 * 2, 0, k])
        i += 1
